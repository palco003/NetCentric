"""
This exercise introduces the idea of variables.
I have chosen to use format prints as opposed to how it's done in the book.
"""
cars = 100
space_in_a_car = 4.0
drivers = 30
...
print "We have {} passengers to carpool today.".format(passengers)
